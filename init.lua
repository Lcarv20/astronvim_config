...
local config = {
  ...
  lsp = {
    ...
    ["server-settings"] = {
      -- gopls = { -- for gopls lspconfig setup call
      --   -- don't need to configure filetype or cmd because installer sets that up automatically
      --   settings = {
      --     gopls = {
      --       analyses = {
      --         unusedparams = true,
  ...
  plugins = {
    ...
    bufferline = { -- override bufferline configuration
      options = {
